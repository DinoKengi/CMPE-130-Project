...
public:
    Ogre() : Monster("Ogre", 100, 20, 5, 8) {} 
};

class Goblin : public Monster {
public:
    Goblin() : Monster("Goblin", 40, 10, 2, 12) {} 
    void attack() override;
};

class Slime : public Monster {
public:
    Slime() : Monster("Slime", 30, 5, 1, 6) {} 
    void attack() override;
};

class Bandit : public Monster {
public:
    Bandit() : Monster("Bandit", 70, 15, 5, 14) {} 
    void attack() override;
};

class Ghost : public Monster {
public:
    Ghost() : Monster("Ghost", 50, 15, 2, 10) {} 
    void attack() override;
};

class Dragon : public Monster {
public:
    Dragon() : Monster("Dragon", 2000, 60, 30, 5) {} 
    void attack() override;
};
